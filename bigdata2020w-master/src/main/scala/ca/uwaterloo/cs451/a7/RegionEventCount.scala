...
object RegionEventCount {
  ...
  def main(argv: Array[String]): Unit = {
    ...
    val wc = stream.map(_.split(","))
      .map(line => if (line(0)== "green") ((line(8).toDouble, line(9).toDouble),1) else ((line(10).toDouble, line(11).toDouble),1))
      .filter(p =>((p._1._1 > -74.012083 && p._1._1 < -74.009867)      
                &&(p._1._2 > 40.720053 && p._1._2 < 40.7217236 ))
                ||((p._1._1> -74.0144185 && p._1._1 < -74.013777)
                &&(p._1._2> 40.7138745 && p._1._2 < 40.7152275 ))) 
      .map(p => {
        if ((p._1._1.toDouble > -74.012083 && p._1._1.toDouble < -74.009867)      
            && (p._1._2.toDouble > 40.720053 && p._1._2.toDouble < 40.7217236 ))
           ("citigroup",1)
        else ("goldman",1)
        })
